...
public class StatsActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        case R.id.cfSite:
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.codeforces.com")));
            break;
        case R.id.conList:
            startActivity(new Intent(StatsActivity.this, ContestListActivity.class));
            break;
        }
    ...
    private class JsonTask extends AsyncTask<String, Void, Exception> {
        ...
        protected Exception doInBackground(String... links) {
            ...
            try {
                ...
                for (int i = 0; i < results.length(); i++) {
                    ...
                    if (!verdict.containsKey(vdt))
                        verdict.put(vdt, 1);
                    else
                        verdict.put(vdt, verdict.get(vdt) + 1);
                ...
                try {
                    con = info.getString("country");
                } catch (JSONException e) {
                    con = "";
                }
                try {
                    rat = Integer.toString(info.getInt("rating"));
                } catch (JSONException e) {
                    rat = "";
                }
                try {
                ...
                try {
                    orgn = info.getString("organization");
                } catch (JSONException e) {
                    orgn = "";
                }
                userInfo = " Profile: \n\n Name: \t" + Username + "\n Rating: \t" + rat + "\n Rank: \t" + rank
        ...
        protected void onPostExecute(Exception e) {
            ...
            for (String vdt : verdict.keySet()) {
                switch (vdt) {
                case "WRONG_ANSWER":
                    verd.put("WA", verdict.get(vdt));
                    break;
                case "OK":
                    verd.put("AC", verdict.get(vdt));
                    break;
                case "COMPILATION_ERROR":
                    verd.put("CE", verdict.get(vdt));
                    break;
                case "RUNTIME_ERROR":
                    verd.put("RTE", verdict.get(vdt));
                    break;
                case "TIME_LIMIT_EXCEEDED":
                    verd.put("TLE", verdict.get(vdt));
                    break;
                case "MEMORY_LIMIT_EXCEEDED":
                    verd.put("MLE", verdict.get(vdt));
                    break;
                case "CHALLENGED":
                    verd.put("Challenged", verdict.get(vdt));
                    break;
                case "SKIPPED":
                    verd.put("Skipped", verdict.get(vdt));
                    break;
                default:
                    verd.put("Others", verdict.get(vdt));
                }
            }
            ...
            pieChart2.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                ...
                public void onValueSelected(Entry e, Highlight h) {
                    PieEntry pe = (PieEntry) e;
                    Toast.makeText(getApplicationContext(), pe.getLabel() + ": " + (int) pe.getValue(),
            ...
            // Bar chart for problems solved of levels
            ...
            desc3.setText("Level Stats ");
            desc3.setTextSize(20f);
            ...
            barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                ...
                public void onValueSelected(Entry e, Highlight h) {
                    ...
                    Toast.makeText(getApplicationContext(), labels.get((int) be.getX()) + ": " + (int) be.getY(),
                            Toast.LENGTH_SHORT).show();
                }
            ...
            desc4.setText("Rating Change Curve");
            desc4.setTextSize(20f);
            lineChart.setDescription(desc4);
            ...
            lineChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                ...
                public void onValueSelected(Entry e, Highlight h) {
                    int idx = (int) e.getX();
                    int val = (int) e.getY();
                    Toast.makeText(getApplicationContext(), "Contest ID: " + idx + "\nEvaluated Rating: " + val,
                            Toast.LENGTH_SHORT).show();
                }
